...
* [BIO / IOB Tagged Text to Original Text](https://medium.com/analytics-vidhya/bio-tagged-text-to-original-text-99b05da6664)

  https://github.com/jerilkuriakose/BIO-IOB-tags-to-original-text

* [**Named Entity Recognition (NER) | Custom Advanced NLP Tool using spaCy**](https://suneelpatel-in.medium.com/named-entity-recognition-ner-custom-advanced-nlp-tool-using-spacy-568a8fbbe0d4)
